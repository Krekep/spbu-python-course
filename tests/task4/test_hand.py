...
class TestHand:
    ...
    @pytest.mark.parametrize("cards,expected_value,expected_blackjack,expected_busted", [
    ...
    def test_various_hand_scenarios(self, cards, expected_value, expected_blackjack, expected_busted):
